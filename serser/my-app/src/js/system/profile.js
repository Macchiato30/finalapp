...
form_service.onsubmit = async (e) => {
  ...
  if (error) {
    errorNotification("Something went wrong. Image not uploaded!", 15);
    console.log(error);
  }
  if (for_update_id == "") {
  ...
  services.forEach((service) => {
    container += `<div class="col-sm-12">
                  ...
                  <div class="card-body">
                      ...
                      <div class="dropdown float-end">
                          ...
                          <ul class="dropdown-menu">
                              <li>
                                  <a class="dropdown-item btn_edit" href="#" data-id="${
                                    service.id
                                  }">Edit</a>
                              </li>
                              <li>
      ...
      service.image_path
                              ...
                              <li>
                                  <a class="dropdown-item btn_delete" href="#" data-id="${
                                    service.id
                                  }">Delete</a>
                              </li>
                          </ul>
                      ...
                      <h6 class="card-subtitle mb-2 text-body-secondary">
                          <p data-id="${service.user_id}">Post By: ${
      service.user_id
    }</p>
...
const deleteAction = async (e) => {
  ...
  if (error == null) {
    ...
    successNotification("Service Successfully Deleted!", 15);

    // Remove the Card from the list
    document.querySelector(`.card[data-id="${id}"]`).remove();
  } else {
    // Show error notification
    errorNotification("Something went wrong. Service not Deleted!", 10);
    console.log(error);
...
const editAction = async (e) => {
  ...
  if (error == null) {
    ...
    document.getElementById("facebook").value = service[0].facebook;
